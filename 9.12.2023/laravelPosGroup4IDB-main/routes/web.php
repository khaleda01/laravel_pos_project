...
use App\Http\Controllers\PurchasesorderController;
...
Route::get('/search-product',[SalesorderController::class, 'create'])->name('search-product');

/*-----------------------------purchaseorder------------------------------------*/

Route::get('/order/purchase-order', [PurchasesorderController::class, 'create'])->name('order.purchase-order');
Route::post('/order/purchase-order', [PurchasesorderController::class, 'store'])->name('order.purchase-order.store');
Route::get('/order/purchase-order/all', [PurchasesorderController::class, 'index'])->name('order.purchase-order.all');
Route::get('/order/purchase-order/{PurchaseOrder}', [PurchasesorderController::class, 'show'])->name('order.purchase-order.show');
