...
<head>
    ...
    <link href="{{ asset('assest/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('assest/lib/chart/chart.min.js') }}"></script>
    <script src="{{ asset('assest/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('assest/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('assest/lib/owlcarousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('assest/lib/tempusdominus/js/moment.min.js') }}"></script>
    <script src="{{ asset('assest/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
